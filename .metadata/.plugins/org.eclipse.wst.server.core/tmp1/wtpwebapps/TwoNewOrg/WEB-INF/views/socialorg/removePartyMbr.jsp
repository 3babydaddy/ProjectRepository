...
<head>
	<title></title>
	<script type="text/javascript" src="<c:url value='/resources/js/socialorg/removePartyMbr.js?version=${jsversion}'/>"></script>
</head>
<body >
	   ...
	   <div class="panel-body" align="center">
	    	<label class="checkbox-inline">
			  <input type="checkbox" id="inlineCheckbox1" value="option1"> 纳入社会组织党组织管理的党员
			</label>
	    	<label class="checkbox-inline">
			  <input type="checkbox" id="inlineCheckbox1" value="option1"> 组织关系在社会组织党组织的党员
			</label>
