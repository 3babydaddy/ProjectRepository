...
<%@ include file="/WEB-INF/views/common/upload_e.jsp"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html >
<head>
	<title></title>
	<%@ include file="/WEB-INF/views/index/EasyuiBootstrap.jsp"%>
	<script type="text/javascript" src="<c:url value='/resources/js/socialorg/orgCancel.js?version=${jsversion}'/>"></script>
</head>
<body >
