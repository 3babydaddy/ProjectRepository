...
function loadData(){
	var options = {
			url : ctx+'/socialorg/showPartyInfo',
			...
			columns : [ [
				...
				,{field :"partymbrInSocialorgIs",title :"纳入社会组织党组织管理",width :"20%", align:"center"}   
				,{field :"partymbrGroupInSocialorgIs",title :"组织关系在社会组织党组织",width :"20%", align:"center"}   
	         ] ],
