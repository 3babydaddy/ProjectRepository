...
public class BaseService {
	...
	@Value("${quwei.deptid}")
	private String quweiDeptId ;
	@Value("${datadictionary.qx.parent.permission}")
	private String parentPermission ;
	@Value("${datadictionary.qx.users}")
	private String dictionaryUsers ;
	
	@Autowired
	private PermissionClientService permissionClientService;
	
	
	public boolean isQuWeiDept(){
		
		if(this.quweiDeptId.equals(this.getCurrentUserDeptId())){
			return true;
		}
		return false;
	}
	...
	public String getDictionaryUsers() {
