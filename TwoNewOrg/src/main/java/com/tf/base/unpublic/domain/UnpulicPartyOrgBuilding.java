...
@Table(name = "unpublic_party_org_building")
public class UnpulicPartyOrgBuilding {
	/**
     * 主键
     */
    @Id
    ...
    private Integer unpublicPartyOrgId;
    ...
    public String toString() {
        ...
        sb.append(", unpublicPartyOrgId=").append(unpublicPartyOrgId);
    ...
    public Integer getUnpublicPartyOrgId() {
        return unpublicPartyOrgId;
    }

    public void setUnpublicPartyOrgId(Integer unpublicPartyOrgId) {
