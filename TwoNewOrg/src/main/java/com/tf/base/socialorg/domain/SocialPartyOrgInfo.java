...
@Table(name = "social_party_org_info")
public class SocialPartyOrgInfo {
     ...
     * 与其他单位党组织共用活动场所
     */
    @Column(name = "others_share_stage")
    private String otherShareStage;
    /**
     * 与社区公用活动场所
     */
    @Column(name = "community_share_stage")
     ...
     * 是否将党组织建设有关内容纳入学校章程
     */
    @Column(name = "is_party_into_school")
    private String isPartyIntoSchool;
    /**
     * 隶属上级党组织类别(学校特有)
     */
    @Column(name = "parent_party_org_type")
    ...
    public String toString() {
        ...
        sb.append(", otherShareStage=").append(otherShareStage);
        sb.append(", communityShareStage=").append(communityShareStage);
	...
	public void setOtherShareStage(String otherShareStage) {
		this.otherShareStage = otherShareStage;
	}
