...
<div class="easyui-layout" style="width:100%;height:100%;" >
	...
	<div id="importwin" style="text-align: center;" closed="true">
		<form class="easyui-form" action="${ctx}/unpublic/otherImportPartymbr" method="post" name="editForm" id="editForm"
		...
		<a href="<c:url value='/resources/templet/qita.xlsx'/>" class="easyui-linkbutton" icon="icon-save">下载模板</a>
...
function loadData(){
	var options = {
			url : ctx+'/unpublic/otherPartyMbrList',
			...
			columns : [ [
	            ...
	            ,{field :"workunitAndAddress",title :"工作单位及地址",width :"8%", align:"center"}   
...
function add(){
	var url = ctx + "/unpublic/otherAddPartymbr?mainId="+mainId;
...
function del(){
	...
	var url = ctx + "/unpublic/otherRemovePartymbr?id="+id;
