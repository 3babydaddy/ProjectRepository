...
<div class="easyui-layout" style="width:100%;height:100%;" >
	...
	<div id="importwin" style="text-align: center;" closed="true">
		<form class="easyui-form" action="${ctx}/unpublic/importPartymbr" method="post" name="editForm" id="editForm"
		...
		<a href="<c:url value='/resources/templet/feigong.xlsx'/>" class="easyui-linkbutton" icon="icon-save">下载模板</a>
...
function loadData(){
	var options = {
			...
			columns : [ [
	            ...
	            ,{field :"partymbrInUnpublicIs",title :"组织关系在非公企业",width :"10%", align:"center"}   
	            ,{field :"partymbrMiddleManagerIs",title :"中层管理人员",width :"8%", align:"center"}   
	            ,{field :"partymbrOnMiddletechIs",title :"中高级专业技术人员",width :"10%", align:"center"}   
	            ,{field :"partymbrFrontlineIs",title :"生产经营一线职工",width :"10%", align:"center"}   
...
function add(){
	var url = ctx + "/unpublic/addPartymbr?mainId="+mainId;
...
function edit(){
	...
	if(id == undefined)
		return;
	var url = ctx + "/unpublic/editPartymbr?mainId="+mainId+'&id='+id;
...
function noUpdateRel(){
	var url = ctx + "/unpublic/noUpdateRel?id="+mainId;
