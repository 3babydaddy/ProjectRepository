...
<div class="easyui-layout" style="width:100%;height:100%;" >
	<div data-options="region:'north'" class="easyui-panel" title="查询" style="width:100%;height: 90px;" align="center">
	  <form id="queryForm" action="" name="queryForm" class="easyui-form" method="post" >		
			...
			<input type="hidden" id="partyOrgId" name="partyOrgId" value="${partyOrgId}" />
		</form>
	</div>
...
function loadData(){
	var options = {
			url : ctx+'/cover/showPartyInfo',
			queryParams : {name:$("#name").val(), coverPartyOrgId:$("#partyOrgId").val()},
			title: '党员列表',
			rownumbers:true,
			fitColumns : true,
			striped : true,
			...
			columns : [ [
	            ...
	            ,{field :"isFromCoverOrg",title :"是否从覆盖组织转入 ",width :"12%", align:"center"}   
	         ] ],
