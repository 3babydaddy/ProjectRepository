...
<head>
	<title></title>
	<script type="text/javascript" src="<c:url value='/resources/js/cover/addPartyMbr.js?version=${jsversion}'/>"></script>
</head>
<body >
	<form id="editForm">
		   ...
		   <div class="panel-body" align="center" >
		   		<table class="table table-bordered" cellpadding="2" border="0" cellspacing="0" >
					...
					<tr>
						...
						<td style="text-align: left;">
							<input id="birthday" name="birthdayTxt" type="text" onClick="WdatePicker({maxDate:'%y-%M-%d'})" class="form-control" />
						</td>
					</tr>
					<tr>
