...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if (window.top !=window.self) {
			window.top.location.href="/PermissionCenter/sysError";
		}
	})
</script>
<body>
<h2>系统异常</h2>
<p>发送系统异常或者您尚未登入，请联系管理员或<a href="javascript:void(0)"  onclick="window.top.location.href='/PermissionCenter/login'">重登入</a>。</p>
</body>
</html>