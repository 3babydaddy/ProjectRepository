package com.tf.permission.client.shiro.others;
...
public class ChainDefinitionSectionMetaSource implements FactoryBean<Ini.Section> {
	...
	private PermissionClientService resourcesMapper;
	

	public void setResourcesMapper(PermissionClientService resourcesMapper) {
	...
	public Ini.Section getObject() throws Exception {
		...
		List<ResourceInfo> lists = resourcesMapper.findAllPermissionBySystemId();
