...
`WIKI vs 文档`：http://git.oschina.net/tf/spring-shiro-training/wikis/Home

`文档vs思维导图`：[开源项目spring-shiro-training思维导图，让项目不再难懂](https://my.oschina.net/u/3080373/blog/875697)

`代码生成详见`：[src/test/java/com/tf/generator/MysqlGenerator](http://git.oschina.net/tf/spring-shiro-training/tree/master/src/test/java/com/tf/generator)
...
<p>
git地址：<a href="https://git.oschina.net/tf/spring-shiro-training.git" target="_blank">https://git.oschina.net/tf/spring-shiro-training.git</a>
</p>
<p>
